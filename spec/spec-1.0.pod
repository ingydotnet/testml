...
Meta statements are key/value pairs separated by a colon and a space. A
...
a short label phrase and a set of named data points.
...
start of the data section. It contains an optional label.
