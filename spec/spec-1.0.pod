...
=item testml_block_marker

If you choose to use the TestML data markup to encode your data section, you
can choose the character sequence to replace the default ('==='). You would
wnat to do this primarily if you had '===' at the beginning of a line in your
data.

Setting this option changes the parser to look for the specified pattern to
find the start of the data section.

    testml_block_marker: *=*

=item testml_point_marker

This option is the same as the testml_block_marker option above, except it is
for the data point marker.
